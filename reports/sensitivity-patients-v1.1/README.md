...
> **v1.2 후속(2026-09-04)**: 이 리포트의 두 서술이 겹치지 않는 코호트에서 뒤집혔다.
> ① **"20명이면 충분"은 철회한다** — 평균에는 충분했으나 순위에는 아니었다. 겹치지
> 않는 20명에서 순위의 Spearman은 **+0.03**(무상관)이고, 여기 1위였던 무재발 보상은
> 거기서 3위, 여기 꼴찌였던 강화항암 사망 HR이 거기서 1위였다. 순위는 **최소 40명**
> 합산으로만 말한다. ② **"20명 전원 부호가 같다"에 반례가 나왔다** — 40명 중 1명이
> −0.0084다. 헤드라인(+0.0313)과 환자간 이질성 서술은 유지된다.
> → [코호트 복제 v1.2](../cohort-replication-v1.2/README.md)
