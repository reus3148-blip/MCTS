...
const sections = [
  ...
  },
  {
    ...
    items: [
      ...
      { text: 'METABRIC 다운로드, 변수 목록 정리', done: false },
  ...
  },
  {
    ...
    items: [
      ...
      { text: 'NCCN 규칙을 정책 매트릭스(표/코드)로 정리', done: false },
    ...
    subsections: [
      {
        ...
        period: '1~2개월',
        items: [
          { text: '결측치 처리 / 이상치 제거 / 변수 표준화', done: false },
          { text: '치료명 텍스트 → 카테고리 변수 변환', done: false },
          { text: '분자아형(HR+/HER2-, TNBC, HR+/HER2+, HR-/HER2+) 라벨링', done: false },
          { text: '정제된 환자 데이터셋 산출', done: false },
        ],
      },
      {
        title: '② 가상 환자 환경 구축',
        period: '2~3개월',
        items: [
          { text: '상태(State) 정의 — 분자아형 × 병기', done: false },
          { text: '행동(Action) 정의 — 수술·항암·방사선·호르몬·표적', done: false },
          { text: '보상(Reward) 함수 — 생존 +, 종양 감소 +, 부작용 −', done: false },
          { text: '전이 확률 추정 (데이터 통계 + 문헌 수치)', done: false },
          { text: '시뮬레이터 함수 구현', done: false },
          { text: '시뮬레이터 sanity check', done: false },
        ],
      },
      {
        title: '③ 두 정책 구현',
        period: '3~5개월',
        items: [
          { text: 'NCCN 정책 — 가이드라인 규칙 코딩', done: false },
          { text: 'MCTS 정책 — 오픈소스 결합 + 시뮬레이터 어댑터', done: false },
      ...
      },
      {
        ...
        items: [
          ...
          { text: 'NCCN 정책 시뮬레이션', done: false },
          { text: 'MCTS 정책 시뮬레이션', done: false },
          { text: '시드 고정·재현성 확인', done: false },
        ],
      },
      {
        title: '⑤ 결과 분석',
        period: '7~9개월',
        items: [
          { text: '평균 생존기간 / 재발률 / 부작용 비율 비교', done: false },
          { text: '정책 결정 일치율 계산', done: false },
          { text: '아형별 서브 분석 (특히 TNBC)', done: false },
          { text: '그래프·표 시각화', done: false },
        ],
      },
    ],
  },
  {
    ...
    items: [
      ...
      { text: 'Limitation 섹션 정리', done: false },
