...
const sections = [
    ...
    subsections: [
      ...
      },
      {
        ...
        items: [
          ...
          { text: 'doubly robust(AIPW)·검열 가중(IPCW) (v0.7)', done: true },
          { text: '결정별 식별 가능성 지도 — 겹침과 교란요인 민감도 (v0.7)', done: true },
          { text: '교란요인 목록 임상 검토', done: false },
          { text: 'utility 가중치 공동 사전등록 (v0.8: 따로 정할 수 없음)', done: false },
          { text: '2차원(상호작용) 민감도 격자 (v0.8)', done: true },
          { text: '가치판단 상호작용 확인 실험 — 시드 12개 (v0.9, 기각)', done: true },
          { text: 'v0.3 일차원 민감도 시드 12개 재실행 (v1.0, 일부 철회)', done: true },
          { text: '환자 수를 늘린 민감도 (다음 병목)', done: false },
          { text: 'v0.5 환경으로 v0.3·v0.4 재실행', done: true },
        ],
      },
    ],
  },
  {
    ...
    items: [
      ...
      { text: '이중강건 v0.7 기술 보고서', done: true },
      { text: '상호작용 민감도 v0.8 기술 보고서', done: true },
      { text: '상호작용 확인 v0.9 기술 보고서', done: true },
      { text: '민감도 재실행 v1.0 기술 보고서', done: true },
      { text: 'v0.5 환경 재실행 리포트 3종', done: true },
